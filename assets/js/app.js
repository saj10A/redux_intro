...
const render = () => {
    document.getElementById("apple_count").innerHTML = store.getState().fruit.apple;
    document.getElementById("orange_count").innerHTML = store.getState().fruit.orange;
    document.getElementById("sandwich_count").innerHTML = store.getState().food.sandwich;
}
store.subscribe(() => {
  render();
})
